...
class Marnet(nx.Graph):
    ...
    def custom_weight(self, u, v, edge_data):
        ...
        avoid_edge = any(value.get("passage", None) in (self.restrictions) for value in edge_values)
    ...
    def filter_avoid_passages(self, u, v, edge_data, args):
        ...
        avoid_edge = any(
            value.get("passage", None) in (self.restrictions or []) for value in edge_values
        )
    ...
    def shortest_path(self, origin, destination):
        ...
        return nx.shortest_path(self, origin_node, destination_node, weight=self.__custom_w)
